		...
		init_change_label : function(){
		    ...
		    for (var i = len; i--;){
		        t.get('.label_'+i+'_0').on('change', function(e){
                    ...
                    t.get('.label_'+chosen_base+'_1').css({ 'display' : 'none' })
                    t.get('.label_'+chosen_base+'_2').css({ 'display' : 'none' })
                    t.get('.label_'+chosen_base+'_3').css({ 'display' : 'none' })
                    t.get('.label_'+chosen).css({ 'display' : 'inline' })
		        })
		    }
		}
	}
