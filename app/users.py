...
class User(object):
    ...
    def __request_profile(self):
        ...
        # Check that the name has between 2 and 30 characters.
        elif not check.length(self.user['name'], 2, 30):
...
def update(_id):
    ...
    if g.my['rank'] > user['rank'] and g.my['rank'] > 15:
        abort(401)
